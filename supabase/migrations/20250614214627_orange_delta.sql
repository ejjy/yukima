/*
  # Age Range Expansion and Premium Products Migration

  1. Database Schema Updates
    - Add age_group column to products table
    - Add premium_tier column to products table
    - Update existing products with new categorization

  2. New Product Data
    - Premium products for mature demographics (35-45)
    - Budget-friendly options for younger users (18-30)
    - Enhanced product categorization by age groups

  3. Enhanced Features
    - Age-appropriate product recommendation function
    - Premium product dupes for cost-conscious users
    - Ingredient analysis for mature skin concerns

  4. Performance Optimizations
    - New indexes for age_group and premium_tier
    - Enhanced views for product recommendations
*/
...
-- Insert premium products for mature demographics (using $$ quoting to avoid escaping issues)
