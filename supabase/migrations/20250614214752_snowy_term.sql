...
-- Additional premium products for comprehensive coverage
('estee-lauder-anr', 'Advanced Night Repair Synchronized Multi-Recovery Complex', 'Serum', ARRAY['Mature', 'All'], ARRAY['Fine Lines', 'Aging'], 4500, 1499, 'Medium', 'Estee Lauder', 'Serum', 'Proven anti-aging night serum', ARRAY['31-35', '36-40', '41-45'], true),
...
('sk2-facial-treatment-essence', 'Facial Treatment Essence', 'Serum', ARRAY['Mature', 'All'], ARRAY['Fine Lines', 'Aging', 'Dullness'], 8500, 1499, 'Low', 'SK-II', 'Serum', 'Iconic pitera essence for skin renewal', ARRAY['36-40', '41-45'], true),

-- Mid-range options for established adults
('neutrogena-rapid-wrinkle-repair', 'Rapid Wrinkle Repair Regenerating Cream', 'Moisturizer', ARRAY['Mature', 'Normal'], ARRAY['Fine Lines', 'Aging'], 1299, 1499, 'Medium', 'Neutrogena', 'Moisturizer', 'Accelerated anti-aging formula', ARRAY['31-35', '36-40'], false),
('olay-eyes-ultimate', 'Eyes Ultimate Eye Cream', 'Eye Care', ARRAY['Mature', 'All'], ARRAY['Fine Lines', 'Dark Circles'], 1299, 1499, 'High', 'Olay', 'Eye Care', 'Peptides and hydration for eye area', ARRAY['31-35', '36-40', '41-45'], false),

-- Young adult focused products
('clean-clear-morning-burst', 'Morning Burst Facial Cleanser', 'Cleanser', ARRAY['Normal', 'Oily'], ARRAY['Acne', 'Oiliness'], 199, 299, 'High', 'Clean & Clear', 'Cleanser', 'Energizing cleanser for young skin', ARRAY['18-24', '25-30'], false),
('garnier-micellar-water', 'Micellar Cleansing Water', 'Cleanser', ARRAY['Normal', 'Sensitive'], ARRAY['Sensitivity'], 199, 299, 'High', 'Garnier', 'Cleanser', 'Gentle makeup removal and cleansing', ARRAY['18-24', '25-30'], false),
('nivea-soft-moisturizer', 'Soft Light Moisturizer', 'Moisturizer', ARRAY['Normal', 'Oily'], ARRAY['Hydration'], 199, 299, 'High', 'Nivea', 'Moisturizer', 'Lightweight daily moisturizer', ARRAY['18-24', '25-30'], false),

-- Additional products for better coverage
('lakme-absolute-perfect-radiance', 'Absolute Perfect Radiance Skin Brightening Day Creme', 'Moisturizer', ARRAY['Normal', 'All'], ARRAY['Dullness', 'Pigmentation'], 450, 499, 'High', 'Lakme', 'Moisturizer', 'Brightening day cream with SPF', ARRAY['25-30', '31-35'], false),
('biotique-bio-morning-nectar', 'Bio Morning Nectar Flawless Skin Lotion', 'Moisturizer', ARRAY['Normal', 'Oily'], ARRAY['Oiliness', 'Acne'], 340, 499, 'High', 'Biotique', 'Moisturizer', 'Ayurvedic lotion for young skin', ARRAY['18-24', '25-30'], false),
('forest-essentials-kumkumadi', 'Kumkumadi Tailam Night Treatment Oil', 'Serum', ARRAY['Mature', 'Dry'], ARRAY['Fine Lines', 'Pigmentation'], 2850, 1499, 'High', 'Forest Essentials', 'Serum', 'Luxury Ayurvedic anti-aging oil', ARRAY['31-35', '36-40', '41-45'], true)
...
('premium-essence-dupe-1', 'SK-II Facial Treatment Essence', 'Olay Regenerist Micro-Sculpting Serum', 8500, 899, 7601, 'Similar peptide technology at fraction of cost', 'Olay', 'Serum'),
('luxury-moisturizer-dupe-1', 'Estee Lauder Advanced Night Repair', 'Neutrogena Rapid Wrinkle Repair', 4500, 1299, 3201, 'Advanced anti-aging ingredients without luxury markup', 'Neutrogena', 'Moisturizer'),
('anti-aging-eye-dupe-1', 'Shiseido Benefiance Eye Cream', 'Olay Eyes Ultimate Eye Cream', 3800, 1299, 2501, 'Peptides and hydration for eye area', 'Olay', 'Eye Care'),
('ayurvedic-luxury-dupe-1', 'Forest Essentials Kumkumadi Oil', 'Biotique Bio Morning Nectar', 2850, 340, 2510, 'Ayurvedic benefits at affordable price', 'Biotique', 'Moisturizer')

ON CONFLICT (id) DO NOTHING;

-- Add ingredient alerts for mature skin (with proper array casting)
...
('peptides', 'Generally Safe', ARRAY[]::text[], 'Skin-firming ingredients suitable for all skin types', ARRAY['Retinol', 'Vitamin C'], '{"risk": "Low", "description": "Well-tolerated"}', '{"Mature": "excellent", "All": "good"}', '{"Fine Lines": "good", "Firmness": "excellent"}'),
('ceramides', 'Very Safe', ARRAY[]::text[], 'Skin barrier strengthening ingredients', ARRAY['Hyaluronic Acid', 'Glycerin'], '{"risk": "Very Low", "description": "Naturally occurring"}', '{"Mature": "excellent", "Dry": "excellent", "Sensitive": "excellent"}', '{"Dryness": "excellent", "Aging": "good"}'),
('alpha-hydroxy-acids', 'Moderate Irritation Risk', ARRAY['Sensitive', 'First-time users'], 'Exfoliating acids that improve skin texture', ARRAY['Enzyme Exfoliants', 'Gentle Scrubs'], '{"risk": "Medium", "description": "Start with low concentration"}', '{"Mature": "good", "Sensitive": "caution"}', '{"Fine Lines": "good", "Pigmentation": "excellent"}'),
('vitamin-c', 'Oxidation & Irritation Risk', ARRAY['Very Sensitive'], 'Antioxidant that brightens and protects skin', ARRAY['Magnesium Ascorbyl Phosphate', 'Arbutin'], '{"risk": "Medium", "description": "Choose stable forms"}', '{"Mature": "excellent", "All": "good"}', '{"Pigmentation": "excellent", "Dullness": "excellent"}'),
('bakuchiol', 'Very Safe', ARRAY[]::text[], 'Natural retinol alternative from babchi plant', ARRAY['Retinol', 'Peptides'], '{"risk": "Very Low", "description": "Pregnancy-safe retinol alternative"}', '{"Mature": "excellent", "Sensitive": "excellent", "Pregnancy": "excellent"}', '{"Fine Lines": "good", "Aging": "good"}'),
('kojic-acid', 'Mild Irritation Risk', ARRAY['Very Sensitive'], 'Natural skin brightening ingredient from fungi', ARRAY['Arbutin', 'Vitamin C'], '{"risk": "Low", "description": "Gentler than hydroquinone"}', '{"Mature": "good", "All": "good"}', '{"Pigmentation": "excellent", "Dark Spots": "excellent"}')
...
-- Create age-specific product count summary
CREATE OR REPLACE VIEW age_group_product_summary AS
SELECT 
  age_range,
  ...
  COUNT(*) FILTER (WHERE premium_tier = true) as premium_count
FROM (
  SELECT 
    unnest(age_group) as age_range,
    price,
    premium_tier
  FROM products
  WHERE age_group IS NOT NULL AND array_length(age_group, 1) > 0
) age_products
GROUP BY age_range
ORDER BY age_range;

-- Grant access to the summary view
GRANT SELECT ON age_group_product_summary TO authenticated;
GRANT SELECT ON age_group_product_summary TO service_role;